          ...
          <ul class="list-group mb-3 z-depth-1">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center lh-condensed">
              ...
              <div class="col-lg-4 d-flex justify-content-around align-items-center">
                <img src="{{ asset('img/'. $item->product_image) }}" alt="" class="img-fluid" style="width:100px;height:auto;">
                <span class="text-muted">${{$item->product_price}}</span>
                <a href={{"removeFromCart/".$item->cart_id}} class="btn btn-warning">Remove</a>
              </div>
            </li>
            @endforeach
